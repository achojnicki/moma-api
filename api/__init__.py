...
class API:
    project_name="moma-api"
    def __init__(self):
        self.config=adisconfig('/opt/adistools/configs/moma-api.yaml')
        ...
        self.log.info('Starting initialization of moma-api')
        ...
        self.log.success('Initialisation of moma-api succeed')
